    ...
    $.fn.contentPages = function(newsid){
        ...
        $.ajax({
            ...
            success: function(msg){
                ...
                $("div#contentpages").append("<li id='pl' class='cbutton'>„ñ??ë¢?</li>");
                $("div#contentpages").append(msg);
                $("div#contentpages").append("<li id='pn' class='pbutton'>„ñÒ¬?ë¢?</li>");
                $("div#contentpages").append("</ul>");
                //$("li#pl").hide();
        ...
        $.ajax({
            ...
            success: function(msg){
                if(msg=="L0"){
                    ...
                    $().alertwindow("ﬁ˛ÊÃ?Ã≤Ωzá•ç]?µ‰–™Œb??Èk??æﬁ‚à?","");
                }else{
        ...
        $.ajax({
            ...
            success: function(msg){
                if(msg=="L0"){
                    ...
                    $().alertwindow("?µ‰–™Œb????◊G?î¥ñè?±ı?∑\?","");
                }else if(msg=="OK"){
                    $().alertwindow("ì √ë?’e?≥Õ?ÅÉ?????’e‘ ",PDV_RP+"member/member_fav.php");
                }else{
                    alert(msg);
                }
            }
...
$(document).ready(function(){
    ...
    if(downcentstr!=""){
        $("#downcentnotice").html("(„ñ±¥ŒÅ????ÎJà@?ÈÅ?"+downcentstr+")");
    }
...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(msg){
            if(msg=="YES"){
                $("#banzhu").append("???Ú—Œn°œ? | <span id='banzhutj'>?æQ???</span> | <span id='banzhudel'>???ƒf</span> | <span id='banzhudelmincent'>???ƒfì◊Ü‹ær??</span> |").show();
                $().setBg();
