                ...
                <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
                    <div style="padding:0px">
                        ...
                        <div id="pagecontent" class="page_content">
                            ...
                            <img style="line-height: 1.5; display: inline;" alt="" id="sub-image"/>
                    ...
                    <div class="sidebar">
                        <div class="wrap">
                            <ul id="child-menu">
                                <?php
                                require 'mysql.php';
                                $sql = $mysqli->query("select * from menu_info where is_deleted=0 and menu_ename='org'");
                                $sql_arr = mysqli_fetch_assoc($sql);
                                $id = $sql_arr['id'];
            ...
            <div id="spdv_17273" class="pdv_bottom" style="overflow:hidden;width:100%;height:100%">
                <div class="pdv_border" style="border: 0px; height: 29px;">
                    <div style="width:100%;text-align:center;font:12px/20px Arial, Helvetica, sans-serif">
                        <p align="center">
                            <span id="copyright" style="color:#FFFFFF;line-height:2;"></span><span id="foot" tyle="color:#FFFFFF;line-height:2;"></span>
                        </p>
                    </div>
                </div>
            </div>
