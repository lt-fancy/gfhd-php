            ...
            <div id='spdv_17317' class="pdv_content" style="overflow:visible;width:100%;">
                <div class="pdv_border" style="border:0">
                    ...
                    <div id="newscontent">
                        <?php
                            $id=$_GET['id'];
                            $sql = $mysqli->query("select * from recruit_info where id=$id");
                            $sql_arr = mysqli_fetch_assoc($sql);
                            $title=$sql_arr['recruit_title'];
                            $depart=$sql_arr['recruit_department'];
                            $time=$sql_arr['gmt_modified'];
                            $content=$sql_arr['recruit_content'];
                            echo "<div class='newstitle'>$title 【 $depart 】</div>
                                <div class='info'>发布于：$time</div>
                                <div id='con' class='con'><p>$content</p></div>
                            ";
                        ?>
                    </div>
                </div>
