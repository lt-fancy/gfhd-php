...
<script type="text/javascript">
    $(window).load(function () {
        ...
        var subName = getContextPosition().replace(".php","");
        var menu = getMenuByEname(subName);
        var image = getImageByEname(subName);
        $("#sub-image").attr('src','./images/'+image.image_uri);
        $("#sub-title").html(menu.menu_cname);
        $("#sub-content").html(getTextByMenuEname(subName).text);
